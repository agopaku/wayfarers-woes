...
for cand in candidates:
    cid = cand["cand_id"]
    if cid == "CAND_194":
        cand["title"] = "Portrait of Ankita"
        cand["location"] = "Naperville, Illinois, USA"
        cand["description"] = "A lovely outdoor portrait from a portfolio session featuring Ankita in Naperville, Illinois."
        cand["category"] = "portrait"
        cand["status"] = "approve"
        updated_count += 1
        print("Updated CAND_194 details.")
...
if updated_count >= 1:
    ...
    print(f"Error: Could not find CAND_194. Updated count: {updated_count}")
